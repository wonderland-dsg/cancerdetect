...
#ifndef BREAST_CONCER_DETECTION_MY_SCALE_H
#define BREAST_CONCER_DETECTION_MY_SCALE_H
#include <float.h>
#include <stdio.h>
#include <stdlib.h>
#include <ctype.h>
...
int doscale(char* my_save_filename,char* my_restore_filename,char* input_file ,char* output_file)
{
    int i,index;
    ...
    save_filename = my_save_filename;
    restore_filename = my_restore_filename;
...
#endif //BREAST_CONCER_DETECTION_MY_SCALE_H
